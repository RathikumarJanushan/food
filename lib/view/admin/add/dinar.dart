...
class _dinarPageState extends State<dinarPage> {
  ...
  void updateDataInFirestore(String docId, String? imageUrl) {
    ...
    FirebaseFirestore.instance.collection('dinar').doc(docId).update({
      'food': food,
      'price': price,
      'imageUrl': imageUrl,
    }).then((value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('dinar Food'),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('dinar').snapshots(),
